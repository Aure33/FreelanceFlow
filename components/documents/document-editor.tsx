...
import { parisTodayInputValue } from "@/lib/date-fr";
...
// Jour courant au format <input type="date">, calculé à Paris (#113) : le
// serveur (UTC) et le navigateur rendent la même valeur → pas d'erreur
// d'hydratation autour de minuit.
const todayInputValue = () => parisTodayInputValue();
